...
const ForgotPassword = () => {
  ...
  lang.setFallback("en");
    ...
    function handleSubmit(event) {
        ...
        post(route("auth.forgotpasswordSubmit"));
       //  post(route("forgotpasswordSubmit"));
    }
                    ...
                    <div className="row">
                        ...
                        <div className="forget_two col-lg-6 col-sm-12">
                            <div className="oneHeading">
                                ...
                                <p>
                                    Please enter the email you used when you
                                    signed up and we will email you instructions
                            ...
                            <div className="submit_area mt-2">
                                ...
                                />
                                <div className="text-danger" style={{fontSize: '14px'}}>{errors.email}</div>
                            ...
                            <div className="Sign_btn">
                              <button onClick={handleSubmit} className="button-hover-effect">
                                  <a style={{color:"white"}}>Reset password</a>
                                </button>
                            </div>
