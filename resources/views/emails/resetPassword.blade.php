            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#ffdfd9" class="body padding-y">
                        ...
                        <p>We have received the request for password change. please click below button to reset your password.</p>
                        <div class="padding-y padding-t-15">
                            <a href="{{url("/forgot-password/".$token)}}" class="btn btn-chantilly">Change password</a>
                        </div>
                    </td>
                </tr>
            </table>
