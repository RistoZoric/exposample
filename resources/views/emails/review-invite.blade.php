            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#ffdfd9" class="body padding-y">
                        ...
                        <p>Click on the button below to review your creator.</p>
                        <div class="padding-y padding-t-15">
                            <a href="{{ str_replace('creators.', '', route('pages.creator.review', [$user->username, $invite->code])) }}" class="btn btn-chantilly">Review @<?php echo  $user->username; ?></a>
                        </div>
                    </td>
                </tr>
                <tr>
